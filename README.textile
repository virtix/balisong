h1. Map, Reduce, Fold, and Bananas for ColdFusion 9
...
public function inc(any collection){
  return mapper.apply(_inc,collection);
}
...
...
* the definition of the function is frequently specific in-line with the map. However,  
* with ColdFusion, you need to write an _external_ function. This is not bad, and allows 
* the function to be tested directly.
*/
...
h3. @[array|struct] flatten(array a)@
